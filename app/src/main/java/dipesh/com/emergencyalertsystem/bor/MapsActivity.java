...
import dipesh.com.emergencyalertsystem.databinding.ActivityMapsBinding;

public class MapsActivity extends BaseActivity
        implements MapActivityContract.View, RequestDialogFragment.IRequestDialogFragmentListener,
        LocationUtil.LocationListener, GoogleMap.OnMapLongClickListener {
    private static final int INITIAL_ZOOM_LEVEL = 14;

    private GoogleMap mMap;
    private Circle searchCircle;

    private MapActivityContract.Presenter mPresenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new MapActivityPresenter(this, Injection.provideFireBaseAuth(),
                Injection.provideFireBaseDatabase());
        ((ActivityMapsBinding) mBinding).setPresenter(mPresenter);
    ...
    public void showHideLoader(boolean isActive) {
        ((ActivityMapsBinding) mBinding).pbLoader.setVisibility(isActive ? View.VISIBLE : View.GONE);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_my_profile:
                Intent myprofile = new Intent(MapsActivity.this, ProfileActivity.class);
